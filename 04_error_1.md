...
Opencode figured it out ... came to the same conclusion I got and I told it that that passphrase does not work.
Then I gave access to the device, told not to modify bytes on it...
Then I gave it a second device, where I also tested already some own code, which I alloewd full write access.
...
Since ssid was right, no need to rewrite, no pmk, no connectin possible...selfhealing not triggered.
...
...but bofore I stumbled about error #2
